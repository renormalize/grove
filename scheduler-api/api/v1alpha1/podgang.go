...
type PodGangSpec struct {
	...
	// PreferredReuseReservationRef holds the reference to another PodGang resource scheduled previously.
	...
	// +optional
	PreferredReuseReservationRef *NamespacedName `json:"preferredReuseReservationTarget,omitempty"`
}
