...
func (r _resource) createPodCreationTask(logger logr.Logger, pcs *grovecorev1alpha1.PodCliqueSet, pclq *grovecorev1alpha1.PodClique, pclqExpectationsKey string, taskIndex, podHostNameIndex int) utils.Task {
	...
	return utils.Task{
		...
		Fn: func(ctx context.Context) error {
			...
			if err := r.buildResource(pcs, pclq, pod, podHostNameIndex); err != nil {
