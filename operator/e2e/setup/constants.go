...
const (
	...
	// OperatorConfigVolumeName is the volume name in the grove-operator Deployment
	// that mounts the operator ConfigMap. Matches deployment.yaml volume name.
	OperatorConfigVolumeName = "operator-config"

	// OperatorConfigDataKey is the key in the operator ConfigMap containing the config YAML.
	// Matches the key generated by the Helm chart _helpers.tpl.
