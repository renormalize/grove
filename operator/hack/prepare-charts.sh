...
function copy_crds() {
  ...
  declare -a operator_crds=("grove.io_podcliquesets.yaml" "grove.io_podcliques.yaml" "grove.io_podcliquescalinggroups.yaml" "grove.io_clustertopologybindings.yaml" "grove.io_podgangmaps.yaml")
