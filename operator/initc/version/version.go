...
// These variables will be set during building the grove initc via LD_FLAGS
...
var (
	// programName is the name of the initc.
	programName = "grove-initc"
	// gitVersion is the semantic version for grove initc.
